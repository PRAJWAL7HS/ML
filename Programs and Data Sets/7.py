# This example could be simplified a little bit by using Bernoulli
#instead of Categorical, but Categorical makes it possible to use 
#more categories than just TRUE and FALSE.
from bayespy.nodes import Categorical, Mixture
from bayespy.inference import VB
import numpy as np
# NOTE: Python's built-in booleans don't work nicely for indexing, 
#thus define own variables:
FALSE = 0
TRUE = 1
